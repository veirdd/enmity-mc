...
execute as @e[tag=enmity.hit] at @s run playsound entity.evoker.cast_spell neutral @a[distance=0..] ~ ~ ~ 2 1.6 0
execute as @e[tag=enmity.hit] at @s run playsound entity.evoker.cast_spell neutral @a[distance=0..] ~ ~ ~ 2 1.6 0
execute as @e[tag=enmity.hit] at @s run playsound entity.evoker.cast_spell neutral @a[distance=0..] ~ ~ ~ 2 1.6 0
stopsound @a[tag=enmity.hit] neutral entity.cat.hiss
stopsound @a[tag=enmity.hit] neutral block.soul_sand.hit
stopsound @a[tag=enmity.hit] neutral entity.guardian.ambient
