...
execute if entity @s[y_rotation=..-135] run title @s title [{"text":"-<","color":"gray"},{"text":"N","color":"white"},{"text":">-","color":"gray"}]
execute if entity @s[y_rotation=135..] run title @s title [{"text":"-<","color":"gray"},{"text":"N","color":"white"},{"text":">-","color":"gray"}]
execute if entity @s[y_rotation=-135..-45] run title @s title [{"text":"-<","color":"gray"},{"text":"E","color":"white"},{"text":">-","color":"gray"}]
execute if entity @s[y_rotation=-45..45] run title @s title [{"text":"-<","color":"gray"},{"text":"S","color":"white"},{"text":">-","color":"gray"}]
execute if entity @s[y_rotation=45..135] run title @s title [{"text":"-<","color":"gray"},{"text":"W","color":"white"},{"text":">-","color":"gray"}]
