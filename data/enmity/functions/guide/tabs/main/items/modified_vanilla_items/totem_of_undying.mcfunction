tellraw @s [{"text":"-============[","color":"gray"},{"text":"TOTEM OF UNDYING","color":"white","bold":true},{"text":"]===========-","color":"gray"}]

tellraw @s [{"text":"Totems of Undying do not grant Absorption.","color":"gray"}]
