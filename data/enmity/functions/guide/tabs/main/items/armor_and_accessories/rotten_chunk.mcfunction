tellraw @s [{"text":"-==============[","color":"gray"},{"text":"ROTTEN CHUNK","color":"white","bold":true},{"text":"]=============-","color":"gray"}]

tellraw @s [{"text":"Description:\n   Accessory type: effect\n   Regenerates some of the lost health upon taking damage.","color":"gray"}]
tellraw @s [{"text":"\nPrimary obtaining method:\n   Dropped by Giant in its treasure bag in expert mode.","color":"gray"}]
