...
execute if score @s[tag=enmity.hit,type=player] enmity.dmg_rdc matches 1.. unless score @s enmity.dmg_rdc >= @s enmity.taken_dmg run scoreboard players add @s enmity.taken_dmg 1
scoreboard players add @s[tag=enmity.hit,type=!player] enmity.taken_dmg 2
