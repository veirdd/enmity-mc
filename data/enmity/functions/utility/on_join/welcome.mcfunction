...
tellraw @s [{"text":"Use trigger commands to toggle some features. \nType","color":"gray"},{"text":" /trigger enmity.wiki","color":"white","hoverEvent":{"action":"show_text","value":{"text":"Click to run"}},"clickEvent":{"action":"run_command","value":"/trigger enmity.wiki"}},{"text":" to open an interactive guide.\n","color":"gray"}]
