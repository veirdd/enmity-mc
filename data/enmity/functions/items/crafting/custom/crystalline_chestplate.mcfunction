...
kill @s
summon item ~ ~ ~ {Motion:[0.0,0.3,0.0],Item:{id:"minecraft:leather_chestplate",Count:1,tag:{display:{Name:'{"text":"Crystalline Chestplate","italic":false}',color:13731547,Lore:['[{"text":"Set bonus: ","italic":false,"color":"gray"},{"text":"dependent on headpiece","color":"white"}]']},Unbreakable:1,HideFlags:4,Enmity:1,Enmity.CustomCrafting:1,Enmity.ArmorType:"crystalline",AttributeModifiers:[{AttributeName:"generic.armor",Name:"0",Amount:8.0,Operation:0,UUID:[I;1,1,1,3],Slot:"chest"},{AttributeName:"generic.armor_toughness",Name:"0",Amount:3.0,Operation:0,UUID:[I;1,1,1,3],Slot:"chest"}]}}}