...
execute if entity @e[type=#enmity:enemies,tag=!enmity.sentry,tag=!enmity.projectile,distance=..10,limit=1] run function enmity:items/usable/silvan_spirit_staff/attack