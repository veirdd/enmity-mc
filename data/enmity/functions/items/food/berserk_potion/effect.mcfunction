...
execute if score @s enmity.math_a matches 0 run attribute @s generic.luck modifier add 0-0-0-0-4 "0" 1 add
execute if score @s enmity.math_a matches 1 run attribute @s generic.luck modifier add 0-0-0-0-4 "0" 2 add
