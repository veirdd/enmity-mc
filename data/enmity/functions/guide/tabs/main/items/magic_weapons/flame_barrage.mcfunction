tellraw @s [{"text":"-=============[","color":"gray"},{"text":"FLAME BARRAGE","color":"white","bold":true},{"text":"]=============-","color":"gray"}]

tellraw @s [{"text":"Description:\n   Damage: 3\n   Mana usage: 20\n   Cooldown: 4\n   Shoots a barrage of flames.\n   Uses Blaze Powder as ammo.\n   90% chance to not consume ammo.","color":"gray"}]
tellraw @s [{"text":"\nPrimary obtaining method:\n   Dropped by Blazes in hardmode (2.5% chance).","color":"gray"}]
