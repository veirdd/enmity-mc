execute if score @s enmity.snt_ct matches 1.. unless entity @e[type=marker,tag=enmity.this] run summon marker ~ ~ ~ {Tags:["enmity.sentry_anchor","enmity.projectile","enmity.new"]}
