summon minecraft:armor_stand ~ ~-1000 ~ {Small:1,Silent:1,Invisible:1,NoGravity:1,ArmorItems:[{},{},{},{id:"minecraft:warped_fungus_on_a_stick",Count:1,tag:{CustomModelData:1008}}],Tags:["enmity.projectile","enmity.giant","enmity.boulder","enmity.new","enmity.no_motion","enmity.giant"]}
