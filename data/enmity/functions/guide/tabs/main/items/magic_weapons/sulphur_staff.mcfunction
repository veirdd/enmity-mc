tellraw @s [{"text":"-=============[","color":"gray"},{"text":"SULPHUR STAFF","color":"white","bold":true},{"text":"]=============-","color":"gray"}]

tellraw @s [{"text":"Description:\n   Damage: 8\n   Mana usage: 60\n   Cooldown: 12\n   Throws a gunpowder bomb.","color":"gray"}]
tellraw @s [{"text":"\nPrimary obtaining method:\n   Dropped by Creepers in hardmode (2% chance).","color":"gray"}]
