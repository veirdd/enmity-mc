...
execute if block ~ ~ ~ #minecraft:doors[facing=north] run function enmity:utility/solid_detection/doors/north
execute if block ~ ~ ~ #minecraft:doors[facing=south] run function enmity:utility/solid_detection/doors/south
execute if block ~ ~ ~ #minecraft:doors[facing=east] run function enmity:utility/solid_detection/doors/east
execute if block ~ ~ ~ #minecraft:doors[facing=west] run function enmity:utility/solid_detection/doors/west
