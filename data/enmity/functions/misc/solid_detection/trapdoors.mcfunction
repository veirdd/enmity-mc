...
execute if block ~ ~ ~ #minecraft:trapdoors[open=true] run function enmity:misc/solid_detection/trapdoors/open
execute if block ~ ~ ~ #minecraft:trapdoors[open=false] run function enmity:misc/solid_detection/trapdoors/closed
