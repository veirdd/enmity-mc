...
execute if score @s enmity.cooldown matches 0 if predicate enmity:random/random_0.25 if entity @p[distance=..10,gamemode=!creative,gamemode=!spectator] run function enmity:entities/mobs/visage/check_obstruction
