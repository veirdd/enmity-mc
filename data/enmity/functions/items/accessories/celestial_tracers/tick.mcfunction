...
execute unless entity @s[x_rotation=89..] if score @s enmity.midair_time matches 6.. if predicate enmity:entity/is_sneaking run function enmity:items/accessories/celestial_tracers/flight
execute unless entity @s[x_rotation=89..] unless score @s enmity.midair_time matches 6.. if score @s enmity.math_a matches 1.. if predicate enmity:entity/is_sneaking run function enmity:items/accessories/celestial_tracers/flight
