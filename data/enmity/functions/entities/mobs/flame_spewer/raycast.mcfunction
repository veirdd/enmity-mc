...
execute if score @s enmity.raycast matches 64.. run scoreboard players set @s enmity.raycast -1
...
execute if score @s enmity.raycast matches 1.. positioned ^ ^ ^0.5 run function enmity:entities/mobs/flame_spewer/raycast