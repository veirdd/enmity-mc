...
kill @s
summon item ~ ~ ~ {Motion:[0.0,0.3,0.0],Item:{id:"minecraft:warped_fungus_on_a_stick",Count:1,tag:{display:{Name:'{"text":"Ethereal Boots","italic":false}',Lore:['[{"text":"Accessory type: ","italic":false,"color":"gray"},{"text":"mobility","color":"white"}]','[{"text":"Increases movement speed.","italic":false,"color":"gray"}]','[{"text":"Hold sneak to fly.","italic":false,"color":"gray"}]','[{"text":"Look directly down to cancel the flight.","italic":false,"color":"gray"}]']},Unbreakable:1,HideFlags:4,CustomModelData:12,Enmity:1,Enmity.CustomCrafting:1,Enmity.ItemGroups:["accessories","mobility"]}}}