...
effect give @e[type=#enmity:alliance_susceptible,tag=!enmity.custom_mob,tag=enmity.hit,type=!creeper] slowness 1000000 2 true
tag @e[type=#enmity:alliance_susceptible,tag=!enmity.custom_mob,tag=enmity.hit] add enmity.hit_by_alliance
