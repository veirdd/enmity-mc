...
execute at @s positioned ~ ~-1.7 ~ anchored eyes run tp @e[type=armor_stand,tag=enmity.new] ^0.4 ^ ^0.2
execute at @s anchored eyes positioned ^0.4 ^ ^0.5 run particle firework ~ ~ ~ 0.025 0.025 0.025 0.02 1 force
execute at @s anchored eyes positioned ^0.4 ^ ^0.5 run particle dust 0.22 0 0.68 0.7 ~ ~ ~ 0.025 0.025 0.025 0 2 force
execute at @s anchored eyes positioned ^0.4 ^ ^0.5 run particle dust 0.47 1 0.45 0.7 ~ ~ ~ 0.025 0.025 0.025 0 2 force
