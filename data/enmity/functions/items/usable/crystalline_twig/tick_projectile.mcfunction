...
execute positioned ~ ~-1 ~ as @e[type=#enmity:enemies,tag=!enmity.sentry,tag=!enmity.projectile,distance=..16,limit=1,sort=nearest] run tag @s add enmity.homing_target
