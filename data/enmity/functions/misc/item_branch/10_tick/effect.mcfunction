...
execute if score @s enmity.use matches 92 run effect give @s saturation 1 0 true
execute if score @s enmity.use matches 105 at @s run function enmity:items/accessories/effervescent_aglets/10_tick
