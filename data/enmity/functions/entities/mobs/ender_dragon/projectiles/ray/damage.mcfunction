...
particle dragon_breath ^ ^ ^0.5 0 0 0 0.075 8 force
playsound entity.puffer_fish.sting neutral @a[distance=0..] ~ ~ ~ 2 0.5 0
playsound entity.puffer_fish.sting neutral @a[distance=0..] ~ ~ ~ 2 1 0
playsound entity.puffer_fish.sting neutral @a[distance=0..] ~ ~ ~ 2 1.5 0
tag @s add enmity.did_damage