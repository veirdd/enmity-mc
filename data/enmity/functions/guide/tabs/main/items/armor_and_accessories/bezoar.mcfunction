tellraw @s [{"text":"-=================[","color":"gray"},{"text":"BEZOAR","color":"white","bold":true},{"text":"]=================-","color":"gray"}]

tellraw @s [{"text":"Description:\n   Accessory type: effect\n   Grants immunity to Poison.","color":"gray"}]
tellraw @s [{"text":"\nPrimary obtaining method:\n   Dropped by Cave Spiders (3% chance).","color":"gray"}]
