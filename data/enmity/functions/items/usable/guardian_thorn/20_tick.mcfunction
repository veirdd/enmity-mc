execute if score @s enmity.age matches 0 run function enmity:items/usable/guardian_thorn/die
...
execute if entity @s if entity @e[type=#enmity:enemies,tag=!enmity.sentry,tag=!enmity.tamed,tag=!enmity.projectile,distance=..20,limit=1] run function enmity:items/usable/guardian_thorn/summon_projectile