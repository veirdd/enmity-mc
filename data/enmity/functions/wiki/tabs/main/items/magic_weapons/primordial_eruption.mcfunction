tellraw @s [{"text":"-==========[","color":"gray"},{"text":"PRIMORDIAL ERUPTION","color":"white","bold":true},{"text":"]==========-","color":"gray"}]

tellraw @s [{"text":"Description:\n   Damage: 27\n   Mana usage: 90\n   Cooldown: 12\n   Creates a large ancient blast of dust.","color":"gray"}]
tellraw @s [{"text":"\nPrimary obtaining method:\n   Enchantment crafting:\n      Dust Storm\n      Ancient Bone Dust\n      Elder Guardian's Scale (4)\n      Red Sand (16)","color":"gray"}]
