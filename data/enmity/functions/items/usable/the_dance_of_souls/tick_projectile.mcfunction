...
execute if entity @s[tag=!enmity.ghast,tag=enmity.player_targeting] if score @s enmity.age matches 15.. positioned ~ ~-1 ~ as @e[type=!#enmity:not_living,tag=!enmity.projectile,distance=..16] unless score @e[tag=enmity.this,limit=1] enmity.player_id = @s enmity.player_id run tag @s add enmity.homing_target
execute if entity @s[tag=!enmity.ghast,tag=!enmity.player_targeting] if score @s enmity.age matches 15.. positioned ~ ~-1 ~ as @e[type=!#enmity:not_living,type=!player,tag=!enmity.projectile,distance=..16] run tag @s add enmity.homing_target
execute facing entity @e[tag=enmity.homing_target,limit=1,sort=nearest] eyes if block ^ ^ ^0.4 #enmity:not_solid run tp @s ^ ^ ^0.4
execute if entity @e[tag=enmity.homing_target] run particle firework
