...
execute if score @s enmity.raycast matches 0 unless block ~ ~-1 ~ #enmity:not_solid unless entity @p[distance=..24] run function enmity:misc/check_sky_access/request
