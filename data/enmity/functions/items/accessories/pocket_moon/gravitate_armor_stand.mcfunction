...
execute if score @s enmity.math_a matches 1 positioned ^ ^ ^1 facing entity @e[type=marker,tag=enmity.direction_anchor] feet positioned ^0.01 ^ ^0.5 run tp @e[type=marker,tag=enmity.direction_anchor] ~ ~ ~
execute if score @s enmity.math_a matches 2 positioned ^ ^ ^1 facing entity @e[type=marker,tag=enmity.direction_anchor] feet positioned ^-0.01 ^ ^0.5 run tp @e[type=marker,tag=enmity.direction_anchor] ~ ~ ~
