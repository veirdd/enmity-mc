...
execute if score @s enmity.flight matches 1.. unless entity @s[x_rotation=89..90] if score @s enmity.midair_time matches 6.. if predicate enmity:entity/is_sneaking run function enmity:items/accessories/ethereal_boots/flight
execute if score @s enmity.flight matches 1.. unless entity @s[x_rotation=89..90] unless score @s enmity.midair_time matches 6.. if score @s enmity.math_a matches 1.. if predicate enmity:entity/is_sneaking run function enmity:items/accessories/ethereal_boots/flight
