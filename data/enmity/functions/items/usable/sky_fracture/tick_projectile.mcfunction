...
execute positioned ~ ~1.7 ~ positioned ^ ^ ^0.25 run function enmity:misc/solid_detection/check
execute positioned ~ ~1.7 ~ positioned ^ ^ ^0.5 run function enmity:misc/solid_detection/check
execute positioned ~ ~1.7 ~ positioned ^ ^ ^0.75 run function enmity:misc/solid_detection/check
...
execute positioned ~ ~1.7 ~ positioned ^ ^ ^0.8 positioned ~-0.25 ~-0.25 ~-0.25 as @e[scores={enmity.iframes=0},type=!#enmity:not_living,tag=!enmity.projectile,dx=0] unless score @e[tag=enmity.this,limit=1] enmity.player_id = @s enmity.player_id positioned ~-0.49 ~-0.49 ~-0.49 if entity @s[dx=0] run tag @s add enmity.hit
