execute if entity @s[tag=!enmity.red] at @s anchored eyes run tp @s ~ ~ ~ facing entity @e[type=#enmity:enemies,tag=!enmity.sentry,tag=!enmity.projectile,sort=nearest,limit=1] eyes
