tellraw @s [{"text":"-=============[","color":"gray"},{"text":"CRYSTAL STORM","color":"white","bold":true},{"text":"]=============-","color":"gray"}]

tellraw @s [{"text":"Description:\n   Damage: 6\n   Mana usage: 30\n   Cooldown: 4\n   Shoots a barrage of crystal shards.","color":"gray"}]
tellraw @s [{"text":"\nPrimary obtaining method:\n   Enchantment crafting:\n      Book\n      Amethyst Shard (8)\n      Nightly Matter (4)","color":"gray"}]
