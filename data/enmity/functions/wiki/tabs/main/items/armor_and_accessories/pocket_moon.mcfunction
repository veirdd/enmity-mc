tellraw @s [{"text":"-==============[","color":"gray"},{"text":"POCKET MOON","color":"white","bold":true},{"text":"]==============-","color":"gray"}]

tellraw @s [{"text":"Description:\n   Accessory type: effect\n   Grants immunity to knockback.","color":"gray"}]
tellraw @s [{"text":"\nPrimary obtaining method:\n   Appears on the ground in skylands biomes at night during the full moon.","color":"gray"}]
tellraw @s [{"text":"\nNotes:\n   Using a Magnet may make finding this item way less tedious.","color":"gray"}]
