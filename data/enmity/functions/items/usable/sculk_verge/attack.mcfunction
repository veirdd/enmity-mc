...
execute as @e[scores={enmity.iframes=0},type=!#enmity:not_living,type=!player,tag=!enmity.projectile,distance=..8] unless score @e[tag=enmity.this,limit=1] enmity.player_id = @s enmity.player_id run tag @s add enmity.hit
execute as @a[scores={enmity.iframes=0},distance=..4] unless score @e[tag=enmity.this,limit=1] enmity.player_id = @s enmity.player_id run tag @s add enmity.hit
