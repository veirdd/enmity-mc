tellraw @s [{"text":"-=============[","color":"gray"},{"text":"LIGHTLY MATTER","color":"white","bold":true},{"text":"]============-","color":"gray"}]

tellraw @s [{"text":"Lightly Matter is an ingredient of many hardmode crafting recipes.","color":"gray"}]
tellraw @s [{"text":"\nPrimary obtaining method:\n   Dropped by Wraiths in hardmode in the Overworld (30% chance).","color":"gray"}]
