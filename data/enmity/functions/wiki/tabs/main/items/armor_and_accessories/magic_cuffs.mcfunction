tellraw @s [{"text":"-==============[","color":"gray"},{"text":"MAGIC CUFFS","color":"white","bold":true},{"text":"]==============-","color":"gray"}]

tellraw @s [{"text":"Description:\n   Accessory type: effect\n   Restores mana upon taking damage.","color":"gray"}]
tellraw @s [{"text":"\nPrimary obtaining method:\n   Fished up as treasure (~6% chance).","color":"gray"}]
