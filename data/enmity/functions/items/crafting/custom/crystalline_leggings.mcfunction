...
kill @s
summon item ~ ~ ~ {Motion:[0.0,0.3,0.0],Item:{id:"minecraft:leather_leggings",Count:1,tag:{display:{Name:'{"text":"Crystalline Leggings","italic":false}',color:13731547,Lore:['[{"text":"Set bonus: ","italic":false,"color":"gray"},{"text":"dependent on headpiece","color":"white"}]']},Unbreakable:1,HideFlags:4,Enmity:1,Enmity.CustomCrafting:1,Enmity.ArmorType:"crystalline",AttributeModifiers:[{AttributeName:"generic.armor",Name:"",Amount:6.0,Operation:0,UUID:[I;1,1,1,2],Slot:"legs"},{AttributeName:"generic.armor_toughness",Name:"",Amount:3.0,Operation:0,UUID:[I;1,1,1,2],Slot:"legs"}],Enmity.ItemGroups:["armor"]}}}