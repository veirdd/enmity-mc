tellraw @s [{"text":"-=============[","color":"gray"},{"text":"LUMINOUS JEWEL","color":"white","bold":true},{"text":"]============-","color":"gray"}]

tellraw @s [{"text":"Description:\n   Accessory type: effect\n   Grants Night Vision when equipped.\n   Hold to reveal nearby livings.","color":"gray"}]
tellraw @s [{"text":"\nPrimary obtaining method:\n   Crafting:\n      [-][0][-]\n      [0][1][0]\n      [-][2][-]\n      0 - Amethyst Shard\n      1 - Glowstone Dust\n      2 - Blaze Powder","color":"gray"}]
