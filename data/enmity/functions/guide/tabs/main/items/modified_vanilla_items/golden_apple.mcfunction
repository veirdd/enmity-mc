...
tellraw @s [{"text":"A Golden Apple provides 5 hunger points instead of 4, grants Regeneration II for 10 seconds instead of 5, and does not grant Absorption.","color":"gray"}]
