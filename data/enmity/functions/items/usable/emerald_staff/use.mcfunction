...
scoreboard players set @e[type=marker,tag=enmity.emerald_bolt,tag=enmity.new] enmity.dmg 6
scoreboard players operation @e[type=marker,tag=enmity.new] enmity.dmg += @s enmity.dmg_bst
tp @e[type=marker,tag=enmity.emerald_bolt,tag=enmity.new] @s
...
tag @e[type=marker,tag=enmity.emerald_bolt,tag=enmity.new] remove enmity.new