tellraw @s [{"text":"-=============[","color":"gray"},{"text":"ENTRAIL SPEWER","color":"white","bold":true},{"text":"]============-","color":"gray"}]

tellraw @s [{"text":"Description:\n   Damage: 3\n   Mana usage: 10\n   Cooldown: 4\n   Spews clusters of rotten flesh.\n   Uses Rotten Flesh as ammo.\n   60% chance to not consume ammo.","color":"gray"}]
tellraw @s [{"text":"\nPrimary obtaining method:\n   Dropped by Giant in its treasure bag.","color":"gray"}]
