tellraw @s [{"text":"-==========[","color":"gray"},{"text":"WITHERING BEAM STAFF","color":"white","bold":true},{"text":"]=========-","color":"gray"}]

tellraw @s [{"text":"Description:\n   Damage: 32\n   Mana usage: 140\n   Cooldown: 32\n   Casts a ray that deals massive damage upon activation.","color":"gray"}]
tellraw @s [{"text":"\nPrimary obtaining method:\n   Dropped by Wither in its treasure bag.","color":"gray"}]
