execute unless predicate enmity:environment/is_night if predicate enmity:environment/is_raining run playsound enmity:ambience.insects ambient @s ~ ~ ~ 0.1 1 0
