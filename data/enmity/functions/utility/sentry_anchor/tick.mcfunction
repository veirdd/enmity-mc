...
function enmity:utility/sentry_anchor/check
...
execute as @e[type=marker,tag=enmity.this,scores={enmity.age=5..}] at @s run function enmity:utility/sentry_anchor/anchor
