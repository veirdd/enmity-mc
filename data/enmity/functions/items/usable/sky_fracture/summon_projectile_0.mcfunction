...
execute at @s positioned ~ ~-1.7 ~ anchored eyes run tp @e[type=armor_stand,tag=enmity.sky_fracture,tag=enmity.new] ^-0.3 ^ ^0.2
execute at @s anchored eyes positioned ^-0.3 ^ ^0.5 run particle firework ~ ~ ~ 0.025 0.025 0.025 0.02 3 force
execute at @s anchored eyes positioned ^-0.3 ^ ^0.5 run particle dust 0.45 0.8 1 0.7 ~ ~ ~ 0.025 0.025 0.025 0 3 force
