execute positioned ^ ^ ^1 facing entity @e[type=!#enmity:not_living,tag=enmity.homing_target,limit=1,sort=nearest] eyes positioned ^ ^ ^0.075 run summon marker ~ ~ ~ {Tags:["enmity.direction_anchor"]}
