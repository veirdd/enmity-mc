...
scoreboard players set @e[type=!#enmity:not_living,tag=enmity.hit] enmity.iframes 8
effect give @e[type=!#enmity:not_living,tag=enmity.hit] slowness 3 4 true
tag @e[type=!#enmity:not_living,tag=enmity.hit] remove enmity.hit
function enmity:items/usable/web_slinger/die_projectile