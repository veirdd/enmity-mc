...
execute if entity @s[tag=enmity.helium_flash] at @s run function enmity:items/usable/helium_flash/tick_projectile
execute if entity @s[tag=enmity.helium_flash_explosion] at @s run function enmity:items/usable/helium_flash/tick_explosion
