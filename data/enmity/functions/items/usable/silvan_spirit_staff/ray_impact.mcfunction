...
summon armor_stand ~ ~ ~ {NoGravity:1,Tags:["enmity.projectile","enmity.new","enmity.silvan_spirit","enmity.sentry"],CustomName:'""',CustomNameVisible:1,DisabledSlots:2039583,ArmorItems:[{},{},{},{id:"warped_fungus_on_a_stick",Count:1,tag:{CustomModelData:1002}}],Silent:1,Invisible:1}
