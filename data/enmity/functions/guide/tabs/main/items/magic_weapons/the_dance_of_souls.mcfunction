tellraw @s [{"text":"-===========[","color":"gray"},{"text":"THE DANCE OF SOULS","color":"white","bold":true},{"text":"]==========-","color":"gray"}]

tellraw @s [{"text":"Description:\n   Damage: 12\n   Mana usage: 160\n   Cooldown: 48\n   Summons a swarm of homing souls.","color":"gray"}]
tellraw @s [{"text":"\nPrimary obtaining method:\n   Enchantment Crafting:\n      Soul Scepter\n      Book\n      Soul Essence (20)\n      Ghast Tear (4)\n      Elder Guardian's Scale (4)","color":"gray"}]
