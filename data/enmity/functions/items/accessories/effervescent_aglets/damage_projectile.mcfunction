...
execute as @e[type=!#enmity:not_living,tag=enmity.hit,type=!player] at @s run function enmity:misc/damage/init
...
execute as @a[tag=enmity.hit,gamemode=!creative,gamemode=!spectator,tag=!enmity.update_health] run function enmity:misc/health_modification/request
