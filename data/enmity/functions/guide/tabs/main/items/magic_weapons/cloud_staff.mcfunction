tellraw @s [{"text":"-==============[","color":"gray"},{"text":"CLOUD STAFF","color":"white","bold":true},{"text":"]==============-","color":"gray"}]

tellraw @s [{"text":"Description:\n   Damage: 7\n   Mana usage: 180\n   Cooldown: 40\n   Summons an ominous looking cloud.","color":"gray"}]
tellraw @s [{"text":"\nPrimary obtaining method:\n   Enchantment crafting:\n      Silvan Spirit Staff\n      Nether Star (3)\n      Cloud (16)\n      Must be crafted at a great height during the rain.","color":"gray"}]
