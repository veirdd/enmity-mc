...
execute if score @s enmity.raycast matches 0 run function enmity:items/usable/silvan_spirit_staff/ray_impact
execute if score @s enmity.raycast matches 1.. positioned ^ ^ ^0.5 if block ~ ~ ~ #enmity:not_solid run function enmity:items/usable/silvan_spirit_staff/raycast