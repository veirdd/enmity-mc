...
execute if entity @s[tag=enmity.heal,tag=!enmity.give_instant_health,tag=!enmity.update_health] run function enmity:misc/health_modification/increase_health_by_1
