...
tellraw @s [{"text":"   - Zombified Piglins become hostile if a player is too close to them.","color":"gray"}]
tellraw @s [{"text":"   - Health regeneration from eating food is slower.","color":"gray"}]
