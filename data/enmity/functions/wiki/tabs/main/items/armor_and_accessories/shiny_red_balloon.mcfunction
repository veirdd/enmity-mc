tellraw @s [{"text":"-===========[","color":"gray"},{"text":"SHINY RED BALLOON","color":"white","bold":true},{"text":"]===========-","color":"gray"}]

tellraw @s [{"text":"Description:\n   Accessory type: effect\n   Grants Jump Boost and Slow Falling.","color":"gray"}]
tellraw @s [{"text":"\nPrimary obtaining method:\n   Crafting:\n      [-][2][-]\n      [-][1][-]\n      [-][0][-]\n      0 - String\n      1 - Phantom Membrane\n      2 - Red Dye","color":"gray"}]
