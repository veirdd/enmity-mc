tellraw @s [{"text":"-==============[","color":"gray"},{"text":"GUST CASTER","color":"white","bold":true},{"text":"]==============-","color":"gray"}]

tellraw @s [{"text":"Description:\n   Damage: 7\n   Mana usage: 100\n   Cooldown: 24\n   Fires a short ranged whirlwind.","color":"gray"}]
tellraw @s [{"text":"\nPrimary obtaining method:\n   Crafting:\n      [-][1][2]\n      [-][0][1]\n      [0][-][-]\n      0 - Iron Ingot\n      1 - Prismarine Shard\n      2 - Phantom Membrane","color":"gray"}]
