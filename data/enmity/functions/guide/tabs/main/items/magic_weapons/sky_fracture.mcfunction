tellraw @s [{"text":"-==============[","color":"gray"},{"text":"SKY FRACTURE","color":"white","bold":true},{"text":"]=============-","color":"gray"}]

tellraw @s [{"text":"Description:\n   Damage: 9\n   Mana usage: 80\n   Cooldown: 16\n   Fires 3 swords in quick succession.","color":"gray"}]
tellraw @s [{"text":"\nPrimary obtaining method:\n   Enchantment crafting:\n      Diamond Sword\n      Nether Quartz (16)\n      Lightly Matter (6)","color":"gray"}]
