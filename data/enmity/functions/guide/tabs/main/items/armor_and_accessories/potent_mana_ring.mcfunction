tellraw @s [{"text":"-============[","color":"gray"},{"text":"POTENT MANA RING","color":"white","bold":true},{"text":"]===========-","color":"gray"}]

tellraw @s [{"text":"Description:\n   Accessory type: mana\n   +20/s Mana regeneration\n   +400 Mana capacity","color":"gray"}]
tellraw @s [{"text":"\nPrimary obtaining method:\n   Enchantment crafting:\n      Mana Power Ring\n      Nether Star (3)\n      Lapis Lazuli","color":"gray"}]
