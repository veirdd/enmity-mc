tellraw @s [{"text":"-==============[","color":"gray"},{"text":"WARPED GLYPH","color":"white","bold":true},{"text":"]=============-","color":"gray"}]

tellraw @s [{"text":"Description:\n   Accessory type: effect\n   +4 Magic cooldown\n   Duplicates your spells at an orbiting anchor.\n   Halves your magic damage increase.","color":"gray"}]
tellraw @s [{"text":"\nPrimary obtaining method:\n   Dropped by Warped Visages in hardmode (3% chance).","color":"gray"}]
