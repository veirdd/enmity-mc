...
execute positioned ~ ~1.8 ~ facing entity @e[type=#enmity:enemies,tag=!enmity.sentry,tag=!enmity.projectile,distance=..6,limit=1,sort=nearest] eyes run function enmity:items/usable/dazzling_rod/attack