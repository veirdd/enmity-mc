tellraw @s [{"text":"-===============[","color":"gray"},{"text":"WITHERBONE","color":"white","bold":true},{"text":"]==============-","color":"gray"}]

tellraw @s [{"text":"Witherbones are a pre-hardmode crafting ingredient.","color":"gray"}]
tellraw @s [{"text":"\nPrimary obtaining method:\n   Dropped by Wither Skeletons and End Wither Skeletons (0-2).","color":"gray"}]
