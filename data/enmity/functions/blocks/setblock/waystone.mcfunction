...
data modify entity @s Item merge value {id:"minecraft:item_frame",Count:1,tag:{hold:{display:{Name:'{"text":"Waystone","italic":false}'}},EntityTag:{id:"minecraft:item_frame",Facing:1,Invulnerable:1,Invisible:1,Silent:1,Fixed:1,Tags:["enmity.block","enmity.block_unset","enmity.projectile"],Item:{id:"minecraft:stone_button",Count:1,tag:{CustomModelData:1}}}}}
