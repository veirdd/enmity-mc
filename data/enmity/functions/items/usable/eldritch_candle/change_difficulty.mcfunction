...
execute if score @s enmity.setup matches 3 run scoreboard players set %difficulty enmity.value 2
execute if score @s enmity.setup matches 3 run scoreboard players set %death_mode enmity.value 1
execute unless score @s enmity.setup matches 3 run scoreboard players set %death_mode enmity.value 0
...
tag @s remove enmity.eldritch_candle_choosing_difficulty
