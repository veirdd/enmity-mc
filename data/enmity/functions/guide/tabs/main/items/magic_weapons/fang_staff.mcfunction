tellraw @s [{"text":"-===============[","color":"gray"},{"text":"FANG STAFF","color":"white","bold":true},{"text":"]==============-","color":"gray"}]

tellraw @s [{"text":"Description:\n   Damage: 12\n   Mana usage: 80\n   Cooldown: 16\n   Shoots a spread of homing poisonous fangs.","color":"gray"}]
tellraw @s [{"text":"\nPrimary obtaining method:\n   Dropped by Bats and Cave Spiders in hardmode (2% chance).","color":"gray"}]
