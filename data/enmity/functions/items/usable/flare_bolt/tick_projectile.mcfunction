...
tp ^ ^ ^0.4
particle dripping_lava ~ ~-0.1 ~ 0.07 0.07 0.07 0 1 force
particle flame ~ ~ ~ 0.075 0.075 0.075 0 3 force
...
execute if score @s enmity.impact_ct matches 3.. run function enmity:items/usable/flare_bolt/die_projectile
tag @s remove enmity.this
execute store result score @s enmity.rotation run data get entity @s Rotation[1]
execute if score @s enmity.rotation matches ..-1 positioned ~ ~0.51 ~ run function enmity:utility/solid_detection/check
...
execute if score @s[tag=!enmity.bounced] enmity.rotation matches 1.. positioned ~ ~-0.51 ~ run function enmity:utility/solid_detection/check
...
execute if score @s[tag=!enmity.bounced] enmity.rotation matches -1.. if entity @s[tag=enmity.in_solid] run function enmity:items/usable/water_bolt/x_bounce
tag @s remove enmity.in_solid
execute if score @s[tag=!enmity.bounced] enmity.rotation matches -91..89 positioned ~ ~ ~0.51 run function enmity:utility/solid_detection/check
...
tag @s remove enmity.in_solid
execute unless score @s[tag=!enmity.bounced] enmity.rotation matches -90..90 positioned ~ ~ ~-0.51 run function enmity:utility/solid_detection/check
