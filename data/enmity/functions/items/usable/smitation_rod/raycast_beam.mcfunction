...
particle electric_spark ^ ^ ^0.125 0 0 0 0 1 force
particle bubble_pop ^ ^ ^0.25 0 0 0 0 1 force
particle electric_spark ^ ^ ^0.375 0 0 0 0 1 force
...
execute if score @s enmity.raycast matches 32.. run scoreboard players set @s enmity.raycast -1
