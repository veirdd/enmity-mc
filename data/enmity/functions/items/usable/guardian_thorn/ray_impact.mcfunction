...
summon guardian ~ ~1 ~ {DeathTime:19,NoAI:1,Invulnerable:1,Tags:["enmity.projectile","enmity.new","enmity.guardian_sentry","enmity.sentry"],CustomName:'""',CustomNameVisible:1,DeathLootTable:"minecraft:empty"}
