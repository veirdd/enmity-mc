tellraw @s [{"text":"-============[","color":"gray"},{"text":"CRYSTALLINE TWIG","color":"white","bold":true},{"text":"]===========-","color":"gray"}]

tellraw @s [{"text":"Description:\n   Damage: 6\n   Mana usage: 160\n   Cooldown: 28\n   Creates a volatile crystalline cluster that grows and shatters at enemies.","color":"gray"}]
tellraw @s [{"text":"\nPrimary obtaining method:\n   Enchantment crafting:\n      Infernal Helix Staff\n      Amethyst Shard (20)\n      Lightly Matter (4)","color":"gray"}]
