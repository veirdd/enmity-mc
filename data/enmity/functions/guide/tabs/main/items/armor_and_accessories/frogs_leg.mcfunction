tellraw @s [{"text":"-===============[","color":"gray"},{"text":"FROG'S LEG","color":"white","bold":true},{"text":"]===============-","color":"gray"}]

tellraw @s [{"text":"Description:\n   Accessory type: effect\n   Hold briefly and release sneak to charge a long jump.\n   Disables Jump Boost.","color":"gray"}]
tellraw @s [{"text":"\nPrimary obtaining method:\n   Dropped by Frogs (3% chance).","color":"gray"}]
