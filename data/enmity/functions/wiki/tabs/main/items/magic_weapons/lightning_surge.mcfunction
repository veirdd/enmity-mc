tellraw @s [{"text":"-============[","color":"gray"},{"text":"LIGHTNING SURGE","color":"white","bold":true},{"text":"]============-","color":"gray"}]

tellraw @s [{"text":"Description:\n   Damage: 9\n   Mana usage: 70\n   Cooldown: 8\n   Casts a lightning that channels across enemies.","color":"gray"}]
tellraw @s [{"text":"\nPrimary obtaining method:\n   Spawns when a Diamond Sword is struck by the lightning from a Trident enchanted with Channeling in hardmode.","color":"gray"}]
