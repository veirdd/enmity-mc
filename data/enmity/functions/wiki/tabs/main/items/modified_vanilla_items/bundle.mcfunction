tellraw @s [{"text":"-=================[","color":"gray"},{"text":"BUNDLE","color":"white","bold":true},{"text":"]=================-","color":"gray"}]

tellraw @s [{"text":"Special Bundles with unique textures are dropped by bosses in the form of treasure bags.","color":"gray"}]
tellraw @s [{"text":"\nPrimary obtaining method:\n   Crafting:\n      [0][1][0]\n      [1][-][1]\n      [1][1][1]\n      0 - String\n      1 - Rabbit Hide","color":"gray"}]
