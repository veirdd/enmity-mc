tellraw @s [{"text":"-===========[","color":"gray"},{"text":"ANCIENT BONE DUST","color":"white","bold":true},{"text":"]===========-","color":"gray"}]

tellraw @s [{"text":"Description:\n   Accessory type: effect\n   Grants Haste.","color":"gray"}]
tellraw @s [{"text":"\nPrimary obtaining method:\n   Dropped by Skeletons and Strays (1% chance).","color":"gray"}]
