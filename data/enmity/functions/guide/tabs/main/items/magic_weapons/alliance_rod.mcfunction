tellraw @s [{"text":"-==============[","color":"gray"},{"text":"ALLIANCE ROD","color":"white","bold":true},{"text":"]=============-","color":"gray"}]

tellraw @s [{"text":"Description:\n   Damage: 8\n   Mana usage: 80\n   Cooldown: 60\n   Shoots a magical bolt which makes the hit enemy less aggressive and somewhat confused. Only some enemies are susceptible.","color":"gray"}]
tellraw @s [{"text":"\nPrimary obtaining method:\n   Dropped by Allays in hardmode (1% chance).","color":"gray"}]
