tellraw @s [{"text":"-==============[","color":"gray"},{"text":"SOUL ESSENCE","color":"white","bold":true},{"text":"]=============-","color":"gray"}]

tellraw @s [{"text":"Soul Essences are a pre-hardmode crafting ingredient.","color":"gray"}]
tellraw @s [{"text":"\nPrimary obtaining method:\n   Dropped by Wraiths (1-2, 50% chance).","color":"gray"}]
