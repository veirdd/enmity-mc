tellraw @s [{"text":"-==============[","color":"gray"},{"text":"EYE OF ENDER","color":"white","bold":true},{"text":"]=============-","color":"gray"}]

tellraw @s [{"text":"Obtaining:\n   Enchantment crafting:\n      Ender Pearl (4)\n      Elder Guardian's Scale\n      Crafted in quantity of 4.","color":"gray"}]
