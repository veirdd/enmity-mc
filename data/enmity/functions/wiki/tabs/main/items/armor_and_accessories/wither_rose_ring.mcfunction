tellraw @s [{"text":"-============[","color":"gray"},{"text":"WITHER ROSE RING","color":"white","bold":true},{"text":"]===========-","color":"gray"}]

tellraw @s [{"text":"Description:\n   Accessory type: effect\n   Inflicts Wither onto nearby enemies.\n   Grants immunity to Wither.","color":"gray"}]
tellraw @s [{"text":"\nPrimary obtaining method:\n   Dropped by Wither in its treasure bag in expert mode.","color":"gray"}]
