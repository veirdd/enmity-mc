tellraw @s [{"text":"-=============[","color":"gray"},{"text":"SOUL OF NATURE","color":"white","bold":true},{"text":"]============-","color":"gray"}]

tellraw @s [{"text":"Souls of Nature are a crafting ingredient for some pre-hardmode summoning items.","color":"gray"}]
tellraw @s [{"text":"\nPrimary obtaining method:\n   Enchantment crafting:\n      Soul Essence\n      Wheat Seeds (4)\n      Poppy (2)\n      Dandelion (2)","color":"gray"}]
