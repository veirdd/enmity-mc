tellraw @s [{"text":"-==============[","color":"gray"},{"text":"WEB SLINGER","color":"white","bold":true},{"text":"]==============-","color":"gray"}]

tellraw @s [{"text":"Description:\n   Damage: 8\n   Mana usage: 60\n   Cooldown: 24\n   Sprays out threads of web that slow enemies down.","color":"gray"}]
tellraw @s [{"text":"\nPrimary obtaining method:\n   Dropped by Cave Spiders when killed inside a mineshaft (5% chance).","color":"gray"}]
