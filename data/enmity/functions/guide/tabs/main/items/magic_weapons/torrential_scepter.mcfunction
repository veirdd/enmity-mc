tellraw @s [{"text":"-==========[","color":"gray"},{"text":"TORRENTIAL SCEPTER","color":"white","bold":true},{"text":"]==========-","color":"gray"}]

tellraw @s [{"text":"Description:\n   Damage: 13\n   Mana usage: 100\n   Cooldown: 24\n   Summons 3 torrential bolts that are launched forward after a while.","color":"gray"}]
tellraw @s [{"text":"\nPrimary obtaining method:\n   Dropped by Elder Guardian in its treasure bag.","color":"gray"}]
