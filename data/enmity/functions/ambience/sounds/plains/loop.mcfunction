execute unless predicate enmity:environment/is_night run playsound enmity:ambience.insects ambient @s ~ ~ ~ 0.2 1 0
execute unless predicate enmity:environment/is_night unless predicate enmity:environment/is_raining run playsound enmity:ambience.birds ambient @s ~ ~ ~ 0.25 1 0
