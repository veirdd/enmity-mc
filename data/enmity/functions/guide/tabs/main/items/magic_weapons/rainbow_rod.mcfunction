tellraw @s [{"text":"-===============[","color":"gray"},{"text":"RAINBOW ROD","color":"white","bold":true},{"text":"]==============-","color":"gray"}]

tellraw @s [{"text":"Description:\n   Damage: 30\n   Mana usage: 80\n   Cooldown: 16\n   Casts a controllable rainbow bolt.","color":"gray"}]
tellraw @s [{"text":"\nPrimary obtaining method:\n   Enchantment crafting:\n      Flamelash\n      Lightly Matter (6)\n      Elder Guardian's Scale (3)\n      Amethyst Shard (10)\n      Ghast Tear (2)","color":"gray"}]
