tellraw @s [{"text":"-=========[","color":"gray"},{"text":"ELDER GUARDIAN'S SCALE","color":"white","bold":true},{"text":"]========-","color":"gray"}]

tellraw @s [{"text":"Elder Guardian's Scales serve as a crafting ingredient for some late-game weapons and accessories.","color":"gray"}]
tellraw @s [{"text":"\nPrimary obtaining method:\n   Dropped by Elder Guardian in normal mode (10-20) and expert-mode (15-25).","color":"gray"}]
