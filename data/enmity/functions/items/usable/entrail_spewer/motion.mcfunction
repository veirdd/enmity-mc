...
execute store result entity @e[type=marker,tag=enmity.new,limit=1] Rotation[0] float 1 run data get entity @p[tag=enmity.this] Rotation[0]
execute store result entity @e[type=marker,tag=enmity.new,limit=1] Rotation[1] float 1 run data get entity @p[tag=enmity.this] Rotation[1]
