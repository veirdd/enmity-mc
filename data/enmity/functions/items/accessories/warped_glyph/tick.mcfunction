...
tag @e[type=marker,tag=enmity.this,limit=1] add enmity.this2
kill @e[type=marker,tag=enmity.this,tag=!enmity.this2]
tag @e[type=marker,tag=enmity.this2] remove enmity.this2
