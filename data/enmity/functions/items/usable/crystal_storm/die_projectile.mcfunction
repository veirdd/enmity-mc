execute positioned ^ ^ ^20 positioned ~ ~10 ~ run summon marker ~ ~ ~ {Tags:["enmity.direction_anchor"]}
...
playsound block.glass.break neutral @a[distance=0..] ~ ~ ~ 2.0 1.5 0.0
particle dust 0.75 0.625 0.9 0.7 ~ ~ ~ 0.2 0.2 0.2 0 15 force
