tellraw @s [{"text":"-===============[","color":"gray"},{"text":"FLAMELASH","color":"white","bold":true},{"text":"]===============-","color":"gray"}]

tellraw @s [{"text":"Description:\n   Damage: 10\n   Mana usage: 100\n   Cooldown: 24\n   Casts a controllable ball of fire.","color":"gray"}]
tellraw @s [{"text":"\nPrimary obtaining method:\n   Bartered by Piglins (~1.5% chance).","color":"gray"}]
