...
execute as @a[gamemode=!spectator,predicate=enmity:environment/in_the_nether,predicate=enmity:environment/biome/tag/nether_forest] if predicate enmity:random/random_0.25 at @s run function enmity:entities/mobs/visage/spawning/spawn_check
