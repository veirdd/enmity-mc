...
execute if score %difficulty enmity.value matches 1 run tp @s[predicate=enmity:entity/is_on_ground,scores={enmity.cooldown=0}] ~ ~ ~ facing entity @p[gamemode=!creative,gamemode=!spectator,distance=..12] feet
execute if score %difficulty enmity.value matches 2 run tp @s[predicate=enmity:entity/is_on_ground,scores={enmity.cooldown=0}] ~ ~ ~ facing entity @p[gamemode=!creative,gamemode=!spectator,distance=..16] feet
