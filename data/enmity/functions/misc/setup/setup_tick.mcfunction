...
execute if score %difficulty enmity.value matches 0 unless entity @a[tag=enmity.setup] as @r run function enmity:misc/setup/enable_setup
execute as @a[tag=enmity.setup,scores={enmity.setup=1..}] run function enmity:misc/setup/end_setup