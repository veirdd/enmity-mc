...
playsound block.beacon.deactivate neutral @a[distance=0..] ~ ~ ~ 2 1.7 0
playsound block.beacon.deactivate neutral @a[distance=0..] ~ ~ ~ 2 1.7 0
...
playsound entity.lightning_bolt.thunder neutral @a[distance=0..] ~ ~ ~ 1.5 2 0
summon minecraft:marker ~ ~ ~ {Tags:["enmity.new","enmity.pistol_bullet","enmity.projectile"]}
summon minecraft:marker ~ ~ ~ {Tags:["enmity.new","enmity.pistol_bullet","enmity.projectile"]}
summon minecraft:marker ~ ~ ~ {Tags:["enmity.new","enmity.pistol_bullet","enmity.projectile"]}
summon minecraft:marker ~ ~ ~ {Tags:["enmity.new","enmity.pistol_bullet","enmity.projectile"]}
scoreboard players set @e[type=marker,tag=enmity.pistol_bullet,tag=enmity.new] enmity.dmg 19
