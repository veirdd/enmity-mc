...
execute at @e[type=marker,tag=enmity.zombie_spawn] run summon zombie ~ ~-2 ~ {NoAI:1,Tags:["enmity.zombie_minion","enmity.invulnerable","enmity.rising","enmity.new","enmity.custom_mob"],CanPickUpLoot:0,Invulnerable:1,DeathLootTable:"enmity:entities/zombie_minion",DeathTime:19s}
