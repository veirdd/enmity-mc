...
execute at @p[distance=..64,gamemode=!spectator] run summon area_effect_cloud ~ ~ ~ {Tags:["enmity.zombie_spawn"]}
execute at @p[distance=..64,gamemode=!spectator] run summon area_effect_cloud ~ ~ ~ {Tags:["enmity.zombie_spawn"]}
execute at @p[distance=..64,gamemode=!spectator] run summon area_effect_cloud ~ ~ ~ {Tags:["enmity.zombie_spawn"]}
execute if score %difficulty enmity.value matches 2 at @p[distance=..64,gamemode=!spectator] run summon area_effect_cloud ~ ~ ~ {Tags:["enmity.zombie_spawn"]}
execute as @p[distance=..64,gamemode=!spectator] at @s run spreadplayers ~ ~ 0 12 false @e[type=area_effect_cloud,tag=enmity.zombie_spawn]
