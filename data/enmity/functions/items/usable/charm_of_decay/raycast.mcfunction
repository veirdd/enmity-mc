...
execute if score @s enmity.raycast matches 0 run function enmity:items/usable/charm_of_decay/ray_impact
execute if score @s enmity.raycast matches 1.. positioned ^ ^ ^0.5 if block ~ ~ ~ #enmity:not_solid run function enmity:items/usable/charm_of_decay/raycast