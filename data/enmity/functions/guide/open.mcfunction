...
execute if score @s enmity.guide matches 1 run function enmity:guide/tabs/main
    ...
    execute if score @s enmity.guide matches 12 run function enmity:guide/tabs/main/entities
        execute if score @s enmity.guide matches 121 run function enmity:guide/tabs/main/entities/end_wither_skeleton
        execute if score @s enmity.guide matches 122 run function enmity:guide/tabs/main/entities/hellbat
        execute if score @s enmity.guide matches 123 run function enmity:guide/tabs/main/entities/sculker
        execute if score @s enmity.guide matches 124 run function enmity:guide/tabs/main/entities/smiler
        execute if score @s enmity.guide matches 125 run function enmity:guide/tabs/main/entities/wraith
