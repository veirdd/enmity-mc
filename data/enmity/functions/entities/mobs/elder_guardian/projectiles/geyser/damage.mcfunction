...
scoreboard players set @e[type=!#enmity:not_living,tag=!enmity.invulnerable,tag=enmity.hit] enmity.iframes 15
tag @e[type=!#enmity:not_living,tag=enmity.hit] remove enmity.hit
execute at @s run playsound minecraft:block.fire.extinguish neutral @a[distance=0..] ~ ~ ~ 2 1 0
particle cloud ~ ~ ~ 0.3 0.3 0.3 0.05 20 force