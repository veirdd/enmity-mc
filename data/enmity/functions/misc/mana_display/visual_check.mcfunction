execute if entity @s unless score @s enmity.air matches ..299 unless predicate enmity:entity/is_riding_living_vehicle run function enmity:misc/mana_display/visual_show
