...
tag @s add enmity.die
execute if entity @s[tag=enmity.die] run particle dragon_breath ^ ^ ^0.5 0 0 0 0.075 8 force
execute if entity @s[tag=enmity.die] run playsound entity.puffer_fish.sting neutral @a[distance=0..] ~ ~ ~ 2 0.5 0
execute if entity @s[tag=enmity.die] run playsound entity.puffer_fish.sting neutral @a[distance=0..] ~ ~ ~ 2 1 0
execute if entity @s[tag=enmity.die] run playsound entity.puffer_fish.sting neutral @a[distance=0..] ~ ~ ~ 2 1.5 0