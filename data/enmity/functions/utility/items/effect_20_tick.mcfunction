...
execute if score @s enmity.math_a matches 84 run attribute @s generic.luck modifier add 0-0-0-0-3 "0" 10 add
execute if score @s enmity.math_a matches 100 run attribute @s generic.knockback_resistance modifier add 0-0-0-0-3 "0" 1 add
