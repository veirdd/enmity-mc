...
execute positioned ~ ~1.7 ~ positioned ^ ^ ^0.533 run function enmity:misc/solid_detection/check
execute positioned ~ ~1.7 ~ positioned ^ ^0.3 ^0.267 run function enmity:misc/solid_detection/check
execute positioned ~ ~1.7 ~ positioned ^ ^-0.3 ^0.267 run function enmity:misc/solid_detection/check
execute positioned ~ ~1.7 ~ positioned ^0.3 ^ ^0.267 run function enmity:misc/solid_detection/check
execute positioned ~ ~1.7 ~ positioned ^-0.3 ^ ^0.267 run function enmity:misc/solid_detection/check
