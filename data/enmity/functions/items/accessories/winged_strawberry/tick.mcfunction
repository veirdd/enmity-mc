...
execute if predicate enmity:entity/is_on_ground if score @s enmity.flight matches -6.. run scoreboard players set @s enmity.flight 0
execute unless predicate enmity:entity/is_on_ground if predicate enmity:entity/is_sneaking if score @s enmity.flight matches 0 run function enmity:items/accessories/winged_strawberry/dash
