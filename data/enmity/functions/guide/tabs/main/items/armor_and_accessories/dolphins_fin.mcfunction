tellraw @s [{"text":"-==============[","color":"gray"},{"text":"DOLPHIN'S FIN","color":"white","bold":true},{"text":"]=============-","color":"gray"}]

tellraw @s [{"text":"Description:\n   Accessory type: effect\n   Grants Dolphin's Grace.","color":"gray"}]
tellraw @s [{"text":"\nPrimary obtaining method:\n   Dropped by Dolphins (3% chance).","color":"gray"}]
