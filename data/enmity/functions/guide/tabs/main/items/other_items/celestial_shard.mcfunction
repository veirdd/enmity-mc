tellraw @s [{"text":"-============[","color":"gray"},{"text":"CELESTIAL SHARD","color":"white","bold":true},{"text":"]============-","color":"gray"}]

tellraw @s [{"text":"Celestial Shards are a late-game crafting ingredient, used in the recipes of most high end weapons and accessories.","color":"gray"}]
tellraw @s [{"text":"\nPrimary obtaining method:\n   Dropped by End Wither Skeletons (30% chance).","color":"gray"}]
