...
execute if entity @e[type=#enmity:enemies,tag=!enmity.sentry,tag=!enmity.tamed,tag=!enmity.projectile,distance=..16,limit=1] run function enmity:items/usable/the_dance_of_souls/attack