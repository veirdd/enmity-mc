tellraw @s [{"text":"-============[","color":"gray"},{"text":"NECROMANTIC BREW","color":"white","bold":true},{"text":"]===========-","color":"gray"}]

tellraw @s [{"text":"Description:\n   Accessory type: effect\n   When equipped, Rotten Flesh cures Hunger instead of causing it. It is also more nutrious.","color":"gray"}]
tellraw @s [{"text":"\nPrimary obtaining method:\n   Dropped by Zombies, Zombie Villagers, and Husks (1% chance).","color":"gray"}]
