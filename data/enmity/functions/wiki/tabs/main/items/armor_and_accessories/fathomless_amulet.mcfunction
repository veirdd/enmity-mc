tellraw @s [{"text":"-===========[","color":"gray"},{"text":"FATHOMLESS AMULET","color":"white","bold":true},{"text":"]==========-","color":"gray"}]

tellraw @s [{"text":"Description:\n   Accessory type: effect\n   Grants Night Vision, even in the Deep Dark.\n   Grants immunity to Darkness.\n   Grants cold resistance.","color":"gray"}]
tellraw @s [{"text":"\nPrimary obtaining method:\n   Enchantment crafting:\n      Luminous Jewel\n      Frozen Charm\n      Echo Shard (4)","color":"gray"}]
