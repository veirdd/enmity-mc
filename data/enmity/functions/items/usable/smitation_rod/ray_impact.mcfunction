...
summon armor_stand ^ ^ ^-0.5 {Tags:["enmity.projectile","enmity.new","enmity.smitation_rod","enmity.sentry"],CustomName:'""',CustomNameVisible:1,DisabledSlots:2039583,ArmorItems:[{id:"leather_boots",Count:1b,tag:{display:{color:16156003}}},{id:"leather_leggings",Count:1,tag:{display:{color:16156003}}},{},{id:"copper_block",Count:1}],Silent:1,Invisible:1,Pose:{Head:[180f,0f,0f],RightLeg:[0f,0f,0f],LeftLeg:[0.01f,0f,0f],Body:[0.01f,0f,0f]}}
