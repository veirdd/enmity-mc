tellraw @s [{"text":"-====[","color":"gray"},{"text":"POTENT MANA REGENERATION RING","color":"white","bold":true},{"text":"]====-","color":"gray"}]

tellraw @s [{"text":"Description:\n   Accessory type: mana\n   +2 Mana regeneration\n   +200 Mana capacity","color":"gray"}]
tellraw @s [{"text":"\nPrimary obtaining method:\n   Enchantment crafting:\n      Mana Power Ring\n      Nether Star (3)\n      Redstone Dust","color":"gray"}]
