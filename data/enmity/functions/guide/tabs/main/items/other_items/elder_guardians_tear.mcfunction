tellraw @s [{"text":"-=========[","color":"gray"},{"text":"ELDER GUARDIAN'S TEAR","color":"white","bold":true},{"text":"]=========-","color":"gray"}]

tellraw @s [{"text":"Description:\n   Toggles the rain.","color":"gray"}]
tellraw @s [{"text":"\nPrimary obtaining method:\n   Dropped by Elder Guardian in expert mode.","color":"gray"}]
