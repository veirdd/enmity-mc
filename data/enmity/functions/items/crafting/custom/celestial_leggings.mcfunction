...
kill @s
summon item ~ ~ ~ {Motion:[0.0,0.3,0.0],Item:{id:"minecraft:leather_leggings",Count:1,tag:{display:{Name:'{"text":"Celestial Leggings","italic":false}',color:4142930,Lore:['[{"text":"Set bonus: ","italic":false,"color":"gray"},{"text":"dependent on headpiece","color":"white"}]']},Unbreakable:1,Enmity:1,Enmity.ArmorType:"celestial",AttributeModifiers:[{AttributeName:"generic.armor",Name:"0",Amount:10.0,Operation:0,UUID:[I;1,1,1,2],Slot:"legs"},{AttributeName:"generic.armor_toughness",Name:"0",Amount:5.0,Operation:0,UUID:[I;1,1,1,2],Slot:"legs"}]}}}