...
execute positioned ~ ~0.15 ~ run function enmity:misc/solid_detection/check
execute positioned ~ ~-0.15 ~ run function enmity:misc/solid_detection/check
execute positioned ~0.15 ~ ~ run function enmity:misc/solid_detection/check
execute positioned ~-0.15 ~ ~ run function enmity:misc/solid_detection/check
execute positioned ~ ~ ~0.15 run function enmity:misc/solid_detection/check
execute positioned ~ ~ ~-0.15 run function enmity:misc/solid_detection/check
execute positioned ^ ^ ^0.25 positioned ~ ~0.15 ~ run function enmity:misc/solid_detection/check
execute positioned ^ ^ ^0.25 positioned ~ ~-0.15 ~ run function enmity:misc/solid_detection/check
execute positioned ^ ^ ^0.25 positioned ~0.15 ~ ~ run function enmity:misc/solid_detection/check
execute positioned ^ ^ ^0.25 positioned ~-0.15 ~ ~ run function enmity:misc/solid_detection/check
execute positioned ^ ^ ^0.25 positioned ~ ~ ~0.15 run function enmity:misc/solid_detection/check
