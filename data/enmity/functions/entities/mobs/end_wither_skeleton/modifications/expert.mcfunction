...
attribute @s generic.attack_damage modifier add 0-0-0-0-0 "" 19 multiply_base
attribute @s generic.max_health modifier add 0-0-0-0-0 "" 8 multiply_base
attribute @s generic.follow_range modifier add 0-0-0-0-0 "" 3 multiply_base
