tellraw @s [{"text":"-==============[","color":"gray"},{"text":"HONEY BOTTLE","color":"white","bold":true},{"text":"]=============-","color":"gray"}]

tellraw @s [{"text":"Consuming a Honey Bottle grants Regeneration for 10 seconds.","color":"gray"}]
