execute if entity @s[tag=enmity.ship-pillager] run summon pillager ~ ~ ~ {PersistenceRequired:1b}
execute if entity @s[tag=enmity.ship-vindicator] run summon vindicator ~ ~ ~ {PersistenceRequired:1b}
